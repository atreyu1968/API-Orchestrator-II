...
- **LitAgents 2.9.2 (Regression Rollback)**: Automatic chapter snapshot system stores content before corrections. If score drops by 2+ points between cycles, automatically rolls back affected chapters to pre-correction state and skips corrections that cycle. Logs regression events and prevents destructive correction loops.
